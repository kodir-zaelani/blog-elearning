<div>
    ...
    <div class="blog-sidebar">
        ...
        <div class="single-sidebar post-tab">
            <!-- Tab Nav -->
            <ul class="nav nav-tabs" id="myEvent" role="tablist">
                <li class="nav-item" ><a class="nav-link active" data-toggle="tab" href="#event" role="tab" >Event</a></li>
            ...
            <!--/ End Tab Nav -->
            <div class="tab-content" id="myTabEvent">
                <!-- Popular Posts -->
                ...
                <div class="single-post">
                    ...
                    <div class="post-img">
                        <a href="{{ route('event.show', $event->slug) }}"><img src="{{ $event->imageThumburl }}" alt="{{ $event->title }}"></a>   
                    </div>
                    @else
                    <div class="post-img">
